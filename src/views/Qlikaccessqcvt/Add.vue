...
export default {
  ...
  data: () => ({
    ...
    errorMessage: null,
    toolbar: {
      displayName: "QCVT Qlik Dashboard Users - Add User",
      actions: [{ event: "refresh", icon: "mdi-refresh", hint: "Refresh" }]
    }
  }),
  computed: {
    ...mapState("Qlikaccessqcvt", ["itemLoaded", "itemDirty"]),
  ...
  methods: {
    ...mapGetters("Qlikaccessqcvt", ["isDirty"]),
    ...mapActions("Qlikaccessqcvt", ["saveItem", "cancelItem", "checkload"]),
  ...
  beforeMount() {
    ...
    this.$store.dispatch("Qlikaccessqcvt/createNew");
  },
